...
<head>
	...
	<style>
		...
		#join_mem #join2 li {width:100%;height:28px; padding-left:8px;padding-top:6px;color:#fff;}
...
<body>
	<div id="join_mem">
	  ...
	  <div id="join2">
		  <ul>
			<li><input type="text" name="name" width="140px" placeholder="Name" id="a1"></li>
			<li><input type="text" class="hp" name="hp" placeholder="HP"></li>
		  </ul>
	  </div>
<!-- <div id="write_button"><input type="image" src="image/ok.png"></div>    완료버튼 누르면 id_search.php 실행 -->
